...
import type { DreamResult as DreamCycleResult } from '@killer/core';
import type { Goal } from '@killer/core';
import type { CellStatusReport } from './cells.js';
...
export class CommandHandler {
  ...
  constructor(deps: CommandHandlerDeps) {
    ...
    this.getCellStatus = deps.getCellStatus;
