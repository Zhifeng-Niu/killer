...
import type { HippocampusEngine, Episode } from '@odysseus/core';
...
export function buildSystemPrompt(deps: PromptBuilderDeps): string {
  ...
  parts.push('  - [TOOL: self_list]({"dir":"packages/odysseus-app/src"}) — list your own source files');
  parts.push('  - [TOOL: self_read]({"path":"packages/odysseus-app/src/orchestrator/agent.ts"}) — read your own code');
  ...
  parts.push('  - [TOOL: mutate_source]({"path":"...","instruction":"what to change","projectRoot":"..."}) — modify your source code with compile-verify-rollback');
